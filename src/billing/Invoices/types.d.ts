...
export type InvoiceCreateInput = {
  ...
  custom_fields: Maybe<Array<Maybe<InvoiceSettingCustomFieldInput>>>;
  /** The number of days from when the invoice is created until it is due. Valid
   * only for invoices where \`billing=send_invoice\`.
   */
  days_until_due: Maybe<Scalars["Int"]>;
  /** ID of the default payment source for the invoice. It must belong to the
   * customer associated with the invoice and be in a chargeable state. If not set,
...
export type InvoiceLineItemsWhereInput = {
  invoice: Scalars["ID"];
...
export type InvoiceSettingCustomFieldInput = {
  /** The name of the custom field. */
  name: Scalars["String"];
  /** The value of the custom field. */
  value: Scalars["String"];
...
export type InvoicesListWhereInput = {
...
export type MutationFinalizeInvoiceArgs = {
  where: InvoiceWhereUniqueInput;
  data: Maybe<InvoiceFinalizeInput>;
};

export type MutationPayInvoiceArgs = {
  where: InvoiceWhereUniqueInput;
  data: InvoicePayInput;
};
...
export type MutationMarkInvoiceUncollectibleArgs = {
  where: InvoiceWhereUniqueInput;
};
...
export type Query = {
   ...
   */
  retrieveInvoice: Maybe<Invoice>;
  retrieveInvoiceLineItem: Maybe<LineItem>;
   ...
   * will not show up in invoice listing calls, and you cannot use the API to pay
   * or edit the invoice. If you want to change the amount that your customer will
   * be billed, you can add, remove, or update pending invoice items, or update the
   * customer’s discount.
   *
   ...
   * passed in should be the same as the subscription_proration_date returned on
   * the upcoming invoice resource. The recommended way to get only the prorations
   * being previewed is to consider only proration line items where period[start]
   * is equal to the subscription_proration_date on the upcoming invoice resource.
   */
  retrieveUpcomingInvoice: Maybe<Invoice>;
   ...
   */
  retrieveUpcomingInvoiceLineItems: Maybe<LineItemList>;
  listInvoices: Maybe<InvoiceList>;
};

export type QueryRetrieveInvoiceArgs = {
  where: InvoiceWhereUniqueInput;
};

export type QueryRetrieveInvoiceLineItemArgs = {
  where: InvoiceLineItemsWhereInput;
};

export type QueryRetrieveUpcomingInvoiceArgs = {
  where: UpcomingInvoiceWhereInput;
};

export type QueryRetrieveUpcomingInvoiceLineItemsArgs = {
  where: UpcomingInvoiceLineItemsWhereInput;
};

export type QueryListInvoicesArgs = {
  where: Maybe<InvoicesListWhereInput>;
};
...
/** List of subscription items, each with an attached plan. */
export type SubscriptionItemsInput = {
  /** Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period */
  billing_thresholds: Maybe<BillingThresholds>;
  /** Delete all usage for a given subscription item. Allowed only when deleted is
   * set to true and the current plan’s usage_type is metered.
   */
  clear_usage: Maybe<Scalars["Boolean"]>;
...
export type UpcomingInvoiceLineItemsWhereInput = {
  /** The code of the coupon to apply. If subscription or subscription_items is
   * provided, the invoice returned will preview updating or creating a
   * subscription with that coupon. Otherwise, it will preview applying that coupon
   * to the customer for the next upcoming invoice from among the customer’s
   * subscriptions. The invoice can be previewed without a coupon by passing this
  ...
  invoice_items: Maybe<UpcomingInvoiceWhereInvoiceItemInput>;
  /** A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10. */
  limit: Maybe<Scalars["Int"]>;
  /** A cursor for use in pagination. starting_after is an object ID that
   * defines your place in the list. For instance, if you make a list request and
   ...
   * upcoming invoice. If not provided, but a subscription_items is provided, you
   * will preview creating a subscription with those items. If neither subscription
   ...
   * cycle. This is used to determine the date of the first full invoice, and, for
   * plans with month or year intervals, the day of the month for subsequent
   * invoices. For existing subscriptions, the value can only be set to now or unchanged.
   */
  subscription_billing_cycle_anchor: Maybe<Scalars["DateTime"]>;
  /** Boolean indicating whether this subscription should cancel at the end of the current period. */
  subscription_cancel_at_period_end: Maybe<Scalars["Boolean"]>;
  subscription_cancel_now: Maybe<Scalars["Boolean"]>;
  /** List of subscription items, each with an attached plan. */
  subscription_items: Maybe<SubscriptionItemsInput>;
  /** If previewing an update to a subscription, this decides whether the preview
   * will show the result of applying prorations or not. If set, one of
   * subscription_items or subscription, and one of subscription_items or
   * subscription_trial_end are required.
   */
  subscription_prorate: Maybe<Scalars["Boolean"]>;
   ...
   * the update was done at the specified time. The time given must be within the
   * current subscription period, and cannot be before the subscription was on its
   * current plan. If set, subscription, and one of subscription_items, or
   ...
   */
  subscription_tax_percent: Maybe<Scalars["Float"]>;
  /** If provided, the invoice returned will preview updating or creating a
   * subscription with that trial end. If set, one of \`subscription_items\` or
   * \`subscription\` is required.
   */
  subscription_trial_end: Maybe<Scalars["String"]>;
   ...
   */
  subscription_trial_from_plan: Maybe<Scalars["Boolean"]>;
};

export type UpcomingInvoiceWhereInput = {
  /** The code of the coupon to apply. If subscription or subscription_items is
   * provided, the invoice returned will preview updating or creating a
   * subscription with that coupon. Otherwise, it will preview applying that coupon
   * to the customer for the next upcoming invoice from among the customer’s
...
export type UpcomingInvoiceWhereInvoiceItemInput = {
   ...
   * is displayed in the invoice for easy tracking. This can be unset by updating
   * the value to null and then saving.
   */
  description: Maybe<Scalars["String"]>;
  /** Explicitly controls whether discounts apply to this invoice item. Defaults to true, except for negative invoice items. */
  discountable: Maybe<Scalars["Boolean"]>;
  /** The ID of the invoice item to update in preview. If not specified, a new
   * invoice item will be added to the preview of the upcoming invoice.
   */
  invoiceitem: Maybe<Scalars["ID"]>;
  ...
  quantity: Maybe<Scalars["Int"]>;
  /** The integer unit amount in cents of the charge to be applied to the upcoming
...
export type InvoiceFinalizeInputResolvers<
  Context = StripeContext,
  ParentType = InvoiceFinalizeInput
> = {
  auto_advance: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
};
...
> = {
  ...
  >;
  deleteDraftInvoice: Resolver<
    Maybe<InvoiceDeletePayload>,
    ParentType,
    Context,
    MutationDeleteDraftInvoiceArgs
  >;
  finalizeInvoice: Resolver<
    Maybe<Invoice>,
    ParentType,
    Context,
    MutationFinalizeInvoiceArgs
  >;
  payInvoice: Resolver<
    Maybe<Invoice>,
    ParentType,
    Context,
    MutationPayInvoiceArgs
  >;
  sendInvoice: Resolver<
    Maybe<Invoice>,
    ParentType,
    Context,
    MutationSendInvoiceArgs
  >;
  voidInvoice: Resolver<
    Maybe<Invoice>,
    ParentType,
    Context,
    MutationVoidInvoiceArgs
  >;
  markInvoiceUncollectible: Resolver<
    Maybe<Invoice>,
    ParentType,
    Context,
    MutationMarkInvoiceUncollectibleArgs
  >;
};
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  retrieveInvoice: Resolver<
    Maybe<Invoice>,
    ParentType,
    Context,
    QueryRetrieveInvoiceArgs
  >;
  retrieveInvoiceLineItem: Resolver<
    Maybe<LineItem>,
    ParentType,
    Context,
    QueryRetrieveInvoiceLineItemArgs
  >;
  retrieveUpcomingInvoice: Resolver<
    Maybe<Invoice>,
    ParentType,
    Context,
    QueryRetrieveUpcomingInvoiceArgs
  >;
  retrieveUpcomingInvoiceLineItems: Resolver<
    Maybe<LineItemList>,
    ParentType,
    Context,
    QueryRetrieveUpcomingInvoiceLineItemsArgs
  >;
  listInvoices: Resolver<
    Maybe<InvoiceList>,
    ParentType,
    Context,
    QueryListInvoicesArgs
  >;
};
...
export type Resolvers<Context = StripeContext> = {
  ...
  InvoiceFinalizeInput: InvoiceFinalizeInputResolvers<Context>;
