...
export type BillingSubscriptionItemWhereUniqueInput = {
  subscription_item: Scalars["ID"];
};
...
export type Mutation = {
   ...
   *
   * Usage records provide quantity information that Stripe uses to track how much
   * a customer is using your service. With usage information and the pricing model
   * set up by the metered billing plan, Stripe helps you send accurate invoices to
   * your customers.
   *
   * The default calculation for usage is to add up all the quantity values of the
   * usage records within a billing period. You can change this default behavior
   * with the billing plan’s aggregate_usage parameter. When there is more than one
   * usage record with the same timestamp, Stripe adds the quantity values
   * together. In most cases, this is the desired resolution, however, you can
   * change this behavior with the action parameter.
   *
   * The default pricing model for metered billing is per-unit pricing. For finer
   * granularity, you can configure metered billing to have a tiered pricing model.
   */
...
export type Query = {
   ...
   *
   * The list is sorted in reverse-chronological order (newest first). The first
   * list item represents the most current usage period that hasn’t ended yet.
   * Since new usage records can still be added, the returned summary information
   * for the subscription item’s ID should be seen as unstable until the
   * subscription billing period ends.
   */
  listSubscriptionItemPeriodSummaries: Maybe<UsageRecordList>;
};

export type QueryListSubscriptionItemPeriodSummariesArgs = {
...
export type UsageRecordCreateInput = {
  ...
  /** The timestamp for the usage event. This timestamp must be within the current
   * billing period of the subscription of the provided subscription_item.
   */
  timestamp: Scalars["DateTime"];
  /** Valid values are increment (default) or set. When using increment the
   * specified quantity will be added to the usage at the specified timestamp. The
   * set action will overwrite the usage quantity at that timestamp. If the
   * subscription has billing thresholds, increment is the only allowed value.
   */
  action: Maybe<UsageRecordAction>;
};

export type UsageRecordList = Object & {
  object: Maybe<ObjectType>;
  has_more: Maybe<Scalars["Boolean"]>;
  url: Maybe<Scalars["String"]>;
  data: Maybe<Array<Maybe<UsageRecordSummary>>>;
};

export type UsageRecordSummary = Node &
  Object & {
    id: Scalars["ID"];
    /** String representing the object's type. Objects of the same type share the same value. */
    object: Maybe<ObjectType>;
    ...
    subscriptionItem: Maybe<Scalars["ID"]>;
    /** The total usage within this usage period. */
    total_usage: Maybe<Scalars["Int"]>;
  };
...
export type MutationResolvers<
  ...
  ParentType = Mutation
> = {
  createUsageRecord: Resolver<
    Maybe<UsageRecord>,
    ParentType,
    Context,
    MutationCreateUsageRecordArgs
  >;
};
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  listSubscriptionItemPeriodSummaries: Resolver<
    Maybe<UsageRecordList>,
    ParentType,
    Context,
    QueryListSubscriptionItemPeriodSummariesArgs
  >;
};
...
export type UsageRecordResolvers<
  Context = StripeContext,
  ParentType = UsageRecord
> = {
  id: Resolver<Scalars["ID"], ParentType, Context>;
  livemode: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  quantity: Resolver<Maybe<Scalars["Int"]>, ParentType, Context>;
  subscription_item: Resolver<Maybe<Scalars["ID"]>, ParentType, Context>;
  timestamp: Resolver<Maybe<Scalars["DateTime"]>, ParentType, Context>;
};

export type UsageRecordListResolvers<
  Context = StripeContext,
  ParentType = UsageRecordList
> = {
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  has_more: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  url: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  data: Resolver<Maybe<Array<Maybe<UsageRecordSummary>>>, ParentType, Context>;
};

export type UsageRecordSummaryResolvers<
  Context = StripeContext,
  ParentType = UsageRecordSummary
> = {
  id: Resolver<Scalars["ID"], ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  invoice: Resolver<Maybe<Scalars["ID"]>, ParentType, Context>;
  livemode: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  period: Resolver<Maybe<Period>, ParentType, Context>;
  subscriptionItem: Resolver<Maybe<Scalars["ID"]>, ParentType, Context>;
  total_usage: Resolver<Maybe<Scalars["Int"]>, ParentType, Context>;
};
...
export type Resolvers<Context = StripeContext> = {
  ...
  UsageRecord: UsageRecordResolvers<Context>;
  UsageRecordList: UsageRecordListResolvers<Context>;
  UsageRecordSummary: UsageRecordSummaryResolvers<Context>;
