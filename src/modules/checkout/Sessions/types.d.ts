...
export type DisplayItems = LineItem | Plan | Sku;
...
export type Query = {
  ...
  retrieveSession: Maybe<Session>;
};

export type QueryRetrieveSessionArgs = {
...
/** You can create a Checkout Session on your server and pass the provided token on
 * the client. Read more about Checkout's API integration here.
 */
export type Session = Node &
  Object & {
     ...
     * purchase.
     */
    client_reference_id: Maybe<Scalars["ID"]>;
    ...
    display_items: Maybe<Array<Maybe<DisplayItems>>>;
...
export type SessionCreateInput = {
  ...
  line_items: Maybe<Array<Maybe<LineItemInput>>>;
  ...
  payment_intent_data: Maybe<PaymentIntentDataInput>;
  /** The list of payment method types (e.g. card) that this Checkout Session is allowed to use. */
  payment_method_types: Array<Maybe<Scalars["String"]>>;
...
export type SubscriptionDataInput = {
  ...
  items: Array<Maybe<SubscriptionDataItemsInput>>;
  metadata: Maybe<Scalars["JSON"]>;
  trial_end: Maybe<Scalars["Int"]>;
  trial_period_days: Maybe<Scalars["Int"]>;
};

export type SubscriptionDataItemsInput = {
  plan: Scalars["String"];
  quantity: Maybe<Scalars["Int"]>;
};
...
export type DisplayItemsResolvers<
  Context = StripeContext,
  ParentType = DisplayItems
> = {
  __resolveType: TypeResolveFn<
    "LineItem" | "Plan" | "SKU",
    ParentType,
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  retrieveSession: Resolver<
    Maybe<Session>,
    ParentType,
    Context,
    QueryRetrieveSessionArgs
  >;
};
...
export type SessionResolvers<Context = StripeContext, ParentType = Session> = {
  cancel_url: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  client_reference_id: Resolver<Maybe<Scalars["ID"]>, ParentType, Context>;
  customer: Resolver<Maybe<Scalars["ID"]>, ParentType, Context>;
  customer_email: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  display_items: Resolver<
    Maybe<Array<Maybe<DisplayItems>>>,
    ParentType,
    Context
  >;
  id: Resolver<Scalars["ID"], ParentType, Context>;
  livemode: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  locale: Resolver<Maybe<Locale>, ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  payment_intent: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  ...
  >;
  subscription: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  success_url: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
};
...
export type Resolvers<Context = StripeContext> = {
  ...
  DisplayItems: DisplayItemsResolvers;
  ...
  Session: SessionResolvers<Context>;
