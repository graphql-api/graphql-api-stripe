...
export type InvoiceItemCreateInput = {
   ...
   * invoice item will be be added to the next upcoming scheduled invoice. When
   * set, scheduled invoices for subscriptions other than the specified
   * subscription will ignore the invoice item. Use this when you want to express
   * that an invoice item has been accrued within the context of a particular subscription.
   */
  subscription: Maybe<Scalars["ID"]>;
...
export type Mutation = {
  ...
  /** Deletes an invoice item, removing it from an invoice. Deleting invoice items
   * is only possible when they’re not attached to invoices, or if it’s attached to
   * a draft invoice.
   */
  deleteInvoiceItem: Maybe<InvoiceItemDeletePayload>;
};
...
export type Query = {
  ...
  retrieveInvoiceItem: Maybe<InvoiceItem>;
   ...
   */
  listInvoiceItems: Maybe<InvoiceItemList>;
};

export type QueryRetrieveInvoiceItemArgs = {
  where: InvoiceItemWhereUniqueInput;
};

export type QueryListInvoiceItemsArgs = {
  where: Maybe<InvoiceItemWhereInput>;
};
...
export type MutationResolvers<
  ...
  ParentType = Mutation
> = {
  createInvoiceItem: Resolver<
    Maybe<InvoiceItem>,
    ParentType,
    Context,
    MutationCreateInvoiceItemArgs
  >;
  updateInvoiceItem: Resolver<
    Maybe<InvoiceItem>,
    ParentType,
    Context,
    MutationUpdateInvoiceItemArgs
  >;
  deleteInvoiceItem: Resolver<
    Maybe<InvoiceItemDeletePayload>,
    ParentType,
    Context,
    MutationDeleteInvoiceItemArgs
  >;
};
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  retrieveInvoiceItem: Resolver<
    Maybe<InvoiceItem>,
    ParentType,
    Context,
    QueryRetrieveInvoiceItemArgs
  >;
  listInvoiceItems: Resolver<
    Maybe<InvoiceItemList>,
    ParentType,
    Context,
    QueryListInvoiceItemsArgs
  >;
};
