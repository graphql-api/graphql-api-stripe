...
export type BillingSubscriptionWhereUniqueInput = {
  id: Scalars["ID"];
};
...
/** An object with a deleted flag set to true upon success. This call returns an
 * error otherwise, such as if no discount exists on this customer or subscription.
 */
...
export type Mutation = {
  ...
  deleteCustomerDiscount: Maybe<DiscountDeletePayload>;
  /** Removes the currently applied discount on a subscription. */
  deleteSubscriptionDiscount: Maybe<DiscountDeletePayload>;
};

export type MutationDeleteCustomerDiscountArgs = {
  whereCustomer: CustomerWhereUniqueInput;
};

export type MutationDeleteSubscriptionDiscountArgs = {
...
export type DiscountDeletePayloadResolvers<
  Context = StripeContext,
  ParentType = DiscountDeletePayload
> = {
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  deleted: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
};
...
export type MutationResolvers<
  ...
  ParentType = Mutation
> = {
  deleteCustomerDiscount: Resolver<
    Maybe<DiscountDeletePayload>,
    ParentType,
    Context,
    MutationDeleteCustomerDiscountArgs
  >;
  deleteSubscriptionDiscount: Resolver<
    Maybe<DiscountDeletePayload>,
    ParentType,
    Context,
    MutationDeleteSubscriptionDiscountArgs
  >;
};
...
export type Resolvers<Context = StripeContext> = {
  ...
  DiscountDeletePayload: DiscountDeletePayloadResolvers<Context>;
