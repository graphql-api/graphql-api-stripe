...
export type Dispute = Node &
  Object & {
     ...
     */
    balance_transactions: Maybe<Array<Maybe<BalanceTransaction>>>;
    ...
    evidence: Maybe<DisputeEvidence>;
    evidence_details: Maybe<DisputeEvidenceDetails>;
...
export type DisputeEvidence = {
   ...
   */
  cancellation_policy: Maybe<File>;
   ...
   */
  customer_communication: Maybe<File>;
   ...
   * written agreement.
   */
  service_documentation: Maybe<File>;
   ...
   */
  shipping_documentation: Maybe<File>;
...
export type DisputeEvidenceInput = {
  ...
  customer_name: Maybe<Scalars["String"]>;
  customer_purchase_ip: Maybe<Scalars["String"]>;
  customer_signature: Maybe<Scalars["String"]>;
  duplicate_charge_documentation: Maybe<Scalars["String"]>;
  /** Has a maximum character count of 20,000. This can be unset by updating the value to null and then saving. */
  duplicate_charge_explanation: Maybe<Scalars["String"]>;
  duplicate_charge_id: Maybe<Scalars["ID"]>;
  /** Has a maximum character count of 20,000. This can be unset by updating the value to null and then saving. */
  ...
  refund_refusal_explanation: Maybe<Scalars["String"]>;
  service_date: Maybe<Scalars["String"]>;
  service_documentation: Maybe<Scalars["String"]>;
  shipping_address: Maybe<Scalars["String"]>;
  shipping_carrier: Maybe<Scalars["String"]>;
  shipping_date: Maybe<Scalars["String"]>;
  shipping_documentation: Maybe<Scalars["String"]>;
  shipping_tracking_number: Maybe<Scalars["String"]>;
...
export type DisputeList = Object & {
  object: Maybe<ObjectType>;
  has_more: Maybe<Scalars["Boolean"]>;
  url: Maybe<Scalars["String"]>;
  data: Maybe<Array<Maybe<Dispute>>>;
};
...
export type DisputeUpdateInput = {
  /** Evidence to upload, to respond to a dispute. Updating any field in the hash
   * will submit all fields in the hash for review. The combined character count of
   * all fields is limited to 150,000.
   */
  evidence: Maybe<DisputeEvidenceInput>;
  /** A set of key-value pairs that you can attach to a dispute object. This can be
   * useful for storing additional information about the dispute in a structured format.
   */
  metadata: Maybe<Scalars["JSON"]>;
  /** Whether to immediately submit evidence to the bank. If false, evidence is
   * staged on the dispute. Staged evidence is visible in the API and Dashboard,
...
export type DisputeWhereUniqueInput = {
...
export type Mutation = {
  /** When you get a dispute, contacting your customer is always the best first
   * step. If that doesn’t work, you can submit evidence to help us resolve the
   ...
   * better chance of winning your dispute. To figure out which evidence fields to
...
export type Query = {
  ...
  retrieveDispute: Maybe<Dispute>;
  /** Returns a list of your disputes. */
  listDisputes: Maybe<DisputeList>;
};

export type QueryRetrieveDisputeArgs = {
  where: DisputeWhereUniqueInput;
};

export type QueryListDisputesArgs = {
  where: Maybe<DisputeWhereInput>;
};
...
export type DisputeResolvers<Context = StripeContext, ParentType = Dispute> = {
  id: Resolver<Scalars["ID"], ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  amount: Resolver<Maybe<Scalars["Int"]>, ParentType, Context>;
  balance_transactions: Resolver<
    Maybe<Array<Maybe<BalanceTransaction>>>,
    ParentType,
    Context
  >;
  ...
  created: Resolver<Maybe<Scalars["DateTime"]>, ParentType, Context>;
  currency: Resolver<Maybe<Currency>, ParentType, Context>;
  evidence: Resolver<Maybe<DisputeEvidence>, ParentType, Context>;
  evidence_details: Resolver<
    Maybe<DisputeEvidenceDetails>,
    ParentType,
    Context
  >;
  is_charge_refundable: Resolver<
    Maybe<Scalars["Boolean"]>,
    ParentType,
    Context
  >;
  livemode: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  metadata: Resolver<Maybe<Scalars["JSON"]>, ParentType, Context>;
  reason: Resolver<Maybe<DisputeReason>, ParentType, Context>;
  status: Resolver<Maybe<DisputeStatus>, ParentType, Context>;
};

export type DisputeEvidenceResolvers<
  Context = StripeContext,
  ParentType = DisputeEvidence
> = {
  access_activity_log: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  billing_address: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  cancellation_policy: Resolver<Maybe<File>, ParentType, Context>;
  cancellation_policy_disclosure: Resolver<
    Maybe<Scalars["String"]>,
    ParentType,
    Context
  >;
  cancellation_rebuttal: Resolver<
    Maybe<Scalars["String"]>,
    ParentType,
    Context
  >;
  customer_communication: Resolver<Maybe<File>, ParentType, Context>;
  customer_email_address: Resolver<
    Maybe<Scalars["String"]>,
    ParentType,
    Context
  >;
  customer_name: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  customer_purchase_ip: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  customer_signature: Resolver<Maybe<File>, ParentType, Context>;
  duplicate_charge_documentation: Resolver<Maybe<File>, ParentType, Context>;
  duplicate_charge_explanation: Resolver<
    Maybe<Scalars["String"]>,
    ParentType,
    Context
  >;
  duplicate_charge_id: Resolver<Maybe<Scalars["ID"]>, ParentType, Context>;
  product_description: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  receipt: Resolver<Maybe<File>, ParentType, Context>;
  refund_policy: Resolver<Maybe<File>, ParentType, Context>;
  refund_policy_disclosure: Resolver<
    Maybe<Scalars["String"]>,
    ParentType,
    Context
  >;
  refund_refusal_explanation: Resolver<
    Maybe<Scalars["String"]>,
    ParentType,
    Context
  >;
  service_date: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  service_documentation: Resolver<Maybe<File>, ParentType, Context>;
  shipping_address: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  shipping_carrier: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  shipping_date: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  shipping_documentation: Resolver<Maybe<File>, ParentType, Context>;
  shipping_tracking_number: Resolver<
    Maybe<Scalars["String"]>,
    ParentType,
    Context
  >;
  uncategorized_file: Resolver<Maybe<File>, ParentType, Context>;
  uncategorized_text: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
};

export type DisputeEvidenceDetailsResolvers<
  Context = StripeContext,
  ParentType = DisputeEvidenceDetails
> = {
  due_by: Resolver<Maybe<Scalars["DateTime"]>, ParentType, Context>;
  has_evidence: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  past_due: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  submission_count: Resolver<Maybe<Scalars["Int"]>, ParentType, Context>;
};

export type DisputeListResolvers<
  Context = StripeContext,
  ParentType = DisputeList
> = {
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  has_more: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  url: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  data: Resolver<Maybe<Array<Maybe<Dispute>>>, ParentType, Context>;
};
...
export type MutationResolvers<
  ...
  ParentType = Mutation
> = {
  updateDispute: Resolver<
    Maybe<Dispute>,
    ParentType,
    Context,
    MutationUpdateDisputeArgs
  >;
  closeDispute: Resolver<
    Maybe<Dispute>,
    ParentType,
    Context,
    MutationCloseDisputeArgs
  >;
};
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  retrieveDispute: Resolver<
    Maybe<Dispute>,
    ParentType,
    Context,
    QueryRetrieveDisputeArgs
  >;
  listDisputes: Resolver<
    Maybe<DisputeList>,
    ParentType,
    Context,
    QueryListDisputesArgs
  >;
};
...
export type Resolvers<Context = StripeContext> = {
  ...
  Dispute: DisputeResolvers<Context>;
  DisputeEvidence: DisputeEvidenceResolvers<Context>;
  DisputeEvidenceDetails: DisputeEvidenceDetailsResolvers<Context>;
  DisputeList: DisputeListResolvers<Context>;
