...
export type ConfirmationMethod = "manual" | "automatic";
...
export type FailureReason = "USER_ABORT" | "DECLINED" | "PROCESSING_ERROR";
...
export type LastPaymentError = {
   ...
   * rate_limit_error
   */
  type: Maybe<LastPaymentErrorType>;
};
...
export type Mutation = {
  ...
  updatePaymentIntent: Maybe<PaymentIntent>;
   ...
   *
   * If the selected source requires additional authentication steps, the
   * PaymentIntent will transition to the requires_action status and suggest
   * additional actions via next_source_action. If payment fails, the PaymentIntent
   * will transition to the requires_payment_method status. If payment succeeds,
   * the PaymentIntent will transition to the succeeded status (or
   * requires_capture, if capture_method is set to manual). Read the expanded
   * documentation to learn more about server-side confirmation.
   *
   ...
   */
  capturePaymentIntent: Maybe<PaymentIntent>;
   ...
   * operations on the PaymentIntent will fail with an error. For PaymentIntents
   * with status='requires_capture', the remaining amount_capturable will
...
export type MutationCancelPaymentIntentArgs = {
  where: Maybe<PaymentIntentWhereUniqueInput>;
  data: Maybe<PaymentIntentCancelInput>;
};
...
export type NextActionType = "redirect_to_url" | "use_stripe_sdk";
...
export type PaymentIntentCancelInput = {
...
export type PaymentIntentCaptureInput = {
  /** The amount to capture from the PaymentIntent, which must be less than or equal
   * to the original amount. Any additional amount will be automatically refunded.
   * Defaults to the full amount_capturable if not provided.
   */
  amount_to_capture: Maybe<Scalars["Float"]>;
  /** The amount of the application fee (if any) that will be applied to the payment
   * and transferred to the application owner’s Stripe account. For more
   * information, see the PaymentIntents Connect usage guide.
   */
  application_fee_amount: Maybe<Scalars["Float"]>;
};

export type PaymentIntentConfirmInput = {
  /** Email address that the receipt for the resulting payment will be sent to. */
  receipt_email: Maybe<Scalars["String"]>;
  /** The URL to redirect your customer back to after they authenticate or cancel
   * their payment on the payment method’s app or site. If you’d prefer to redirect
   * to a mobile application, you can alternatively supply an application URI
   * scheme. This parameter is only used for cards and other redirect-based payment methods.
   */
  return_url: Maybe<Scalars["String"]>;
  /** Set to true to save the PaymentIntent’s payment method (either source or
   * payment_method) to the associated customer. If the payment method is already
   * attached, this parameter does nothing. This parameter defaults to false and
   * applies to the payment method passed in the same request or the current
   * payment method attached to the PaymentIntent and must be specified again if a
   * new payment method is added.
   */
  save_payment_method: Maybe<Scalars["Boolean"]>;
  /** Shipping information for this PaymentIntent. */
  shipping: Maybe<ShippingInput>;
...
export type PaymentIntentCreateInput = {
   ...
   * parameter defaults to false. If the payment method attached is a card, a
   * return_url may be provided in case additional authentication is required. Read
   * the expanded documentation to learn more about server-side confirmation.
   */
   ...
   * users. This can be unset by updating the value to null and then saving.
   */
  description: Maybe<Scalars["String"]>;
  /** Set of key-value pairs that you can attach to an object. This can be useful
   * for storing additional information about the object in a structured format.
   ...
   * succeeds. For more information, see the PaymentIntents Connect usage guide.
   */
  transfer_data: Maybe<TransferDataInput>;
  /** A string that identifies the resulting payment as part of a group. See the PaymentIntents Connect usage guide for details. */
  transfer_group: Maybe<Scalars["String"]>;
};

/** A object with a data property that contains an array of up to limit
 * PaymentIntents, starting after PaymentIntent starting_after. Each entry in the
 * array is a separate PaymentIntent object. If no more PaymentIntents are
 * available, the resulting array will be empty. This request should never throw an error.
 */
export type PaymentIntentList = Object & {
  object: Maybe<ObjectType>;
  url: Maybe<Scalars["String"]>;
  has_more: Maybe<Scalars["Boolean"]>;
  data: Maybe<Array<Maybe<PaymentIntent>>>;
};
...
export type PaymentIntentWhereUniqueInput = {
  id: Scalars["ID"];
};
...
export type Query = {
   ...
   */
  retrievePaymentIntent: Maybe<PaymentIntent>;
  /** Returns a list of PaymentIntents. */
  listPaymentIntent: Maybe<PaymentIntentList>;
};
...
export type ShippingInput = {
   ...
   * USPS, etc. This can be unset by updating the value to null and then saving.
   */
  carrier: Maybe<Scalars["String"]>;
  ...
  /** The tracking number for a physical product, obtained from the delivery
   * service. If multiple tracking numbers were generated for this purchase, please
   * separate them with commas. This can be unset by updating the value to null and then saving.
   */
  tracking_number: Maybe<Scalars["String"]>;
};
...
/** The data with which to automatically create a Transfer when the payment is
 * finalized. See the PaymentIntents Connect usage guide for details.
 */
...
export type TransferDataInput = {
  /** If specified, successful charges will be attributed to the destination account
   * for tax reporting, and the funds from charges will be transferred to the
   * destination account. The ID of the resulting transfer will be returned on the
...
export type LastPaymentErrorResolvers<
  Context = StripeContext,
  ParentType = LastPaymentError
> = {
  charge: Resolver<Maybe<Scalars["ID"]>, ParentType, Context>;
  code: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  doc_url: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  message: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  param: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  payment_intent: Resolver<Maybe<PaymentIntent>, ParentType, Context>;
  source: Resolver<Maybe<Source>, ParentType, Context>;
  type: Resolver<Maybe<LastPaymentErrorType>, ParentType, Context>;
};
...
> = {
  ...
  >;
  updatePaymentIntent: Resolver<
    Maybe<PaymentIntent>,
    ParentType,
    Context,
    MutationUpdatePaymentIntentArgs
  >;
  confirmPaymentIntent: Resolver<
    Maybe<PaymentIntent>,
    ParentType,
    Context,
    MutationConfirmPaymentIntentArgs
  >;
  capturePaymentIntent: Resolver<
    Maybe<PaymentIntent>,
    ParentType,
    Context,
    MutationCapturePaymentIntentArgs
  >;
  cancelPaymentIntent: Resolver<
    Maybe<PaymentIntent>,
    ParentType,
    Context,
    MutationCancelPaymentIntentArgs
  >;
};

export type NextActionResolvers<
  Context = StripeContext,
  ParentType = NextAction
> = {
  redirect_to_url: Resolver<
    Maybe<NextActionRedirectToUrl>,
    ParentType,
    Context
  >;
  type: Resolver<Maybe<NextActionType>, ParentType, Context>;
  use_stripe_sdk: Resolver<Maybe<Scalars["JSON"]>, ParentType, Context>;
};

export type NextActionRedirectToUrlResolvers<
  Context = StripeContext,
  ParentType = NextActionRedirectToUrl
> = {
...
export type PaymentIntentResolvers<
  Context = StripeContext,
  ParentType = PaymentIntent
> = {
  amount: Resolver<Maybe<Scalars["Float"]>, ParentType, Context>;
  amount_capturable: Resolver<Maybe<Scalars["Float"]>, ParentType, Context>;
  amount_received: Resolver<Maybe<Scalars["Float"]>, ParentType, Context>;
  application: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  application_fee_amount: Resolver<
    Maybe<Scalars["Float"]>,
    ParentType,
    Context
  >;
  canceled_at: Resolver<Maybe<Scalars["DateTime"]>, ParentType, Context>;
  cancellation_reason: Resolver<Maybe<CancellationReason>, ParentType, Context>;
  capture_method: Resolver<Maybe<CaptureMethod>, ParentType, Context>;
  charges: Resolver<Maybe<ChargeList>, ParentType, Context>;
  client_secret: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  confirmation_method: Resolver<Maybe<ConfirmationMethod>, ParentType, Context>;
  created: Resolver<Maybe<Scalars["DateTime"]>, ParentType, Context>;
  currency: Resolver<Maybe<Currency>, ParentType, Context>;
  customer: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  description: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  id: Resolver<Scalars["ID"], ParentType, Context>;
  last_payment_error: Resolver<Maybe<LastPaymentError>, ParentType, Context>;
  livemode: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  metadata: Resolver<Maybe<Scalars["JSON"]>, ParentType, Context>;
  next_action: Resolver<Maybe<NextAction>, ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  on_behalf_of: Resolver<Maybe<Account>, ParentType, Context>;
  payment_method_types: Resolver<
    Maybe<Array<Maybe<Scalars["String"]>>>,
    ParentType,
    Context
  >;
  receipt_email: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  review: Resolver<Maybe<Scalars["ID"]>, ParentType, Context>;
  shipping: Resolver<Maybe<Shipping>, ParentType, Context>;
  source: Resolver<Maybe<Source>, ParentType, Context>;
  statement_descriptor: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  status: Resolver<Maybe<PaymentIntentStatus>, ParentType, Context>;
  transfer_data: Resolver<Maybe<TransferData>, ParentType, Context>;
  transfer_group: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
};

export type PaymentIntentListResolvers<
  Context = StripeContext,
  ParentType = PaymentIntentList
> = {
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  url: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  has_more: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  data: Resolver<Maybe<Array<Maybe<PaymentIntent>>>, ParentType, Context>;
};
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  ...
  retrievePaymentIntent: Resolver<
    ...
    ParentType,
    Context,
    QueryRetrievePaymentIntentArgs
  >;
  listPaymentIntent: Resolver<
    Maybe<PaymentIntentList>,
    ParentType,
    Context,
    QueryListPaymentIntentArgs
  >;
};
...
export type Resolvers<Context = StripeContext> = {
  ...
  LastPaymentError: LastPaymentErrorResolvers<Context>;
  ...
  NextAction: NextActionResolvers<Context>;
  NextActionRedirectToUrl: NextActionRedirectToUrlResolvers<Context>;
  Node: NodeResolvers;
  Object: ObjectResolvers;
  Owner: OwnerResolvers<Context>;
  PackageDimensions: PackageDimensionsResolvers<Context>;
  PaymentIntent: PaymentIntentResolvers<Context>;
  PaymentIntentList: PaymentIntentListResolvers<Context>;
  ...
  Shipping: ShippingResolvers<Context>;
