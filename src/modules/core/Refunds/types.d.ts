...
export type Query = {
   ...
   * convenience, the 10 most recent refunds are always available by default on the charge object.
   */
  listRefunds: Maybe<RefundList>;
};
...
export type QueryRetrieveRefundArgs = {
  where: RefundWhereUniqueInput;
};

export type QueryListRefundsArgs = {
  where: Maybe<RefundWhereInput>;
};
...
export type RefundCreateInput = {
   ...
   */
  amount: Maybe<Scalars["Float"]>;
  /** A set of key-value pairs that you can attach to a Refund object. This can be
   ...
   * duplicate, fraudulent, and requested_by_customer. If you believe the charge to
   * be fraudulent, specifying fraudulent as the reason will add the associated
   * card and email to your blocklists, and will also help us improve our fraud
   ...
   * fee will be refunded. Otherwise, the application fee will be refunded in an
   * amount proportional to the amount of the charge refunded.
   *
   * An application fee can be refunded only by the application that created the charge.
   */
  refund_application_fee: Maybe<Scalars["Boolean"]>;
   ...
   */
  reverse_transfer: Maybe<Scalars["Boolean"]>;
};
...
export type ConnectOnlyDirectiveResolver<
  Result,
  Parent,
  Context = StripeContext,
  Args = {}
...
export type MutationResolvers<
  ...
  ParentType = Mutation
> = {
  createRefund: Resolver<
    Maybe<Refund>,
    ParentType,
    Context,
    MutationCreateRefundArgs
  >;
  updateRefund: Resolver<
    Maybe<Refund>,
    ParentType,
    Context,
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  ...
  retrieveRefund: Resolver<
    Maybe<Refund>,
    ParentType,
    Context,
    QueryRetrieveRefundArgs
  >;
  listRefunds: Resolver<
    Maybe<RefundList>,
    ParentType,
    Context,
    QueryListRefundsArgs
  >;
};
...
export type DirectiveResolvers<Context = StripeContext> = {
  ...
  connectOnly: ConnectOnlyDirectiveResolver<any, any, Context>;
