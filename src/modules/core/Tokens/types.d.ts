...
export type AccountInput = {
  ...
  /** Whether the user described by the data in the token has been shown the Stripe
   * Connected Account Agreement. When creating an account token to create a new
   * Connect account, this value must be true.
   */
  tos_shown_and_accepted: Maybe<Scalars["Boolean"]>;
};
...
export type BankAccountToken = Node &
  Object &
  Token & {
    /** Unique identifier for the object. */
    id: Scalars["ID"];
...
export type BankAccountTokenCreateInput = {
  /** The bank account this token will represent. */
  bank_account: Maybe<BankAccount>;
};

export type BankAccountTokenInput = {
   ...
   */
  account_holder_type: Maybe<BusinessType>;
  /** The routing number, sort code, or other country-appropriate institution number
   * for the bank account. For US bank accounts, this is required and should be the
...
export type CardTokenCreateInput = {
   ...
   * pass in a customer, this is an object containing a user's credit card details,
   * with the options described below.
   */
  card: Maybe<CardTokenInput>;
};
...
export type CardTokenInput = {
  ...
  /** Required in order to add the card to an account; in all other cases, this
   ...
   */
  currency: Maybe<Currency>;
  /** Card security code. Highly recommended to always include this value, but it's
   * required only for accounts based in European countries.
   */
  cvc: Maybe<Scalars["Int"]>;
...
export type CompanyInput = {
  ...
  address_kana: Maybe<AddressKanaInput>;
  /** The Kanji variation of the company’s primary address (Japan only). */
  address_kanji: Maybe<AddressKanjiInput>;
  ...
  name: Maybe<Scalars["String"]>;
  /** The Kana variation of the company’s legal name (Japan only). This can be unset
   * by updating the value to null and then saving.
   */
  name_kana: Maybe<Scalars["String"]>;
  /** The Kanji variation of the company’s legal name (Japan only). This can be
   ...
   * country. (Examples are an Employer ID Number in the U.S., a Business Number in
   * Canada, or a Company Number in the UK.) This can be unset by updating the
   * value to null and then saving.
   */
  tax_id: Maybe<Scalars["ID"]>;
  /** The jurisdiction in which the tax_id is registered (Germany-based companies
   * only). This can be unset by updating the value to null and then saving.
   */
...
export type CustomerBankAccountTokenCreateInput = {
  bank_account: Maybe<Scalars["ID"]>;
  /** The customer (owned by the application’s account) for which to create a token.
   * For use only with Stripe Connect. Also, this can be used only with an OAuth
   * access token or Stripe-Account header. For more details, see Shared Customers.
   */
  customer: Scalars["ID"];
};

export type CustomerCardTokenCreateInput = {
...
export type DocumentInput = {
  /** The back of an ID returned by a file upload with a purpose value of
   * identity_document. This can be unset by updating the value to null and then saving.
   */
  back: Maybe<Scalars["String"]>;
  /** The front of an ID returned by a file upload with a purpose value of
   * identity_document. This can be unset by updating the value to null and then saving.
   */
...
export type IndividualInput = {
  ...
  /** The Kana varation of the individual’s last name (Japan only). This can be
   * unset by updating the value to null and then saving.
   */
  lastNameKana: Maybe<Scalars["String"]>;
  /** The Kanji varation of the individual’s last name (Japan only). This can be
   * unset by updating the value to null and then saving.
   */
  ...
  maiden_mame: Maybe<Scalars["String"]>;
  /** Set of key-value pairs that you can attach to an object. This can be useful
   * for storing additional information about the object in a structured format.
   * Individual keys can be unset by posting an empty value to them. All keys can
   * be unset by posting an empty value to metadata.
   */
  metadata: Maybe<Scalars["JSON"]>;
   ...
   */
  ssn_ast_4: Maybe<Scalars["String"]>;
  /** The individual’s verification document information. */
  verification: Maybe<VerificationInput>;
};
...
export type Mutation = {
  /** Creates a single-use token that represents a credit card’s details. This token
   * can be used in place of a credit card object with any API method. These tokens
   * can be used only once: by creating a new Charge object, or by attaching them
   ...
   */
  createCardToken: Maybe<CardToken>;
  createCustomerCardToken: Maybe<CardToken>;
  createBankAccountToken: Maybe<BankAccountToken>;
  createCustomerBankAccountToken: Maybe<BankAccountToken>;
  /** Creates a single-use token that represents the details of personally
   * identifiable information (PII). This token can be used in place of an
   * id_number in Account or Person Update API methods. A PII token can be used only once.
   */
  createPIIToken: Maybe<PiiToken>;
  createAccountToken: Maybe<AccountToken>;
};

export type MutationCreateCardTokenArgs = {
  data: CardTokenCreateInput;
};

export type MutationCreateCustomerCardTokenArgs = {
  whereAccount: AccountWhereUniqueInput;
  data: CustomerCardTokenCreateInput;
};

export type MutationCreateBankAccountTokenArgs = {
  data: BankAccountTokenCreateInput;
};

export type MutationCreateCustomerBankAccountTokenArgs = {
  whereAccount: AccountWhereUniqueInput;
  data: CustomerBankAccountTokenCreateInput;
};

export type MutationCreatePiiTokenArgs = {
  data: PiiTokenCreateInput;
};

export type MutationCreateAccountTokenArgs = {
...
export type PiiInput = {
  ...
  personal_id_number: Scalars["String"];
};
...
export type PiiTokenCreateInput = {
...
export type Query = {
  ...
  retrieveToken: Maybe<Token>;
};

export type QueryRetrieveTokenArgs = {
 ...
 * returned to your server to use. You should use Checkout, Elements, or our mobile
 * libraries to perform this process, client-side. This ensures that no sensitive
 ...
 * information for later use, you can create Customer objects or Custom accounts.
 * Note that Radar, our integrated solution for automatic fraud protection,
...
export type TokenType = "account" | "bank_account" | "card" | "pii";
...
export type DefaultDirectiveResolver<
  ...
  Args = { value: Maybe<Maybe<Scalars["String"]>> }
...
export type AccountTokenResolvers<
  Context = StripeContext,
  ParentType = AccountToken
> = {
  id: Resolver<Scalars["ID"], ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  client_ip: Resolver<Scalars["String"], ParentType, Context>;
  created: Resolver<Maybe<Scalars["DateTime"]>, ParentType, Context>;
  livemode: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  type: Resolver<Maybe<TokenType>, ParentType, Context>;
  used: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
};
...
export type BankAccountTokenResolvers<
  Context = StripeContext,
  ParentType = BankAccountToken
> = {
  id: Resolver<Scalars["ID"], ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  bank_account: Resolver<Maybe<BankAccount>, ParentType, Context>;
  client_ip: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  created: Resolver<Maybe<Scalars["DateTime"]>, ParentType, Context>;
  livemode: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  type: Resolver<Maybe<TokenType>, ParentType, Context>;
  used: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
...
export type CardTokenResolvers<
  Context = StripeContext,
  ParentType = CardToken
> = {
  id: Resolver<Scalars["ID"], ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
...
export type MutationResolvers<
  ...
  ParentType = Mutation
> = {
  createCardToken: Resolver<
    Maybe<CardToken>,
    ParentType,
    Context,
    MutationCreateCardTokenArgs
  >;
  createCustomerCardToken: Resolver<
    Maybe<CardToken>,
    ParentType,
    Context,
    MutationCreateCustomerCardTokenArgs
  >;
  createBankAccountToken: Resolver<
    Maybe<BankAccountToken>,
    ParentType,
    Context,
    MutationCreateBankAccountTokenArgs
  >;
  createCustomerBankAccountToken: Resolver<
    Maybe<BankAccountToken>,
    ParentType,
    Context,
    MutationCreateCustomerBankAccountTokenArgs
  >;
  createPIIToken: Resolver<
    Maybe<PiiToken>,
    ParentType,
    Context,
    MutationCreatePiiTokenArgs
  >;
  createAccountToken: Resolver<
    Maybe<AccountToken>,
    ParentType,
    Context,
    MutationCreateAccountTokenArgs
  >;
};
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  retrieveToken: Resolver<
    Maybe<Token>,
    ParentType,
    Context,
    QueryRetrieveTokenArgs
  >;
};
...
export type TokenResolvers<Context = StripeContext, ParentType = Token> = {
  __resolveType: TypeResolveFn<
    "CardToken" | "BankAccountToken" | "PIIToken" | "AccountToken",
    ParentType,
    Context
  >;
  id: Resolver<Scalars["ID"], ParentType, Context>;
...
export type Resolvers<Context = StripeContext> = {
  ...
  AccountSettingsPayoutsSchedule: AccountSettingsPayoutsScheduleResolvers<
    Context
  >;
  AccountToken: AccountTokenResolvers<Context>;
  ...
  BankAccountToken: BankAccountTokenResolvers<Context>;
  ...
  CardToken: CardTokenResolvers<Context>;
  ...
  PIIToken: PiiTokenResolvers<Context>;
...
export type DirectiveResolvers<Context = StripeContext> = {
  default: DefaultDirectiveResolver<any, any, Context>;
