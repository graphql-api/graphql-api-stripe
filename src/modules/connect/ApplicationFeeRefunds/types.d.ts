...
export type ApplicationFee = Node &
  Object & {
     ...
     */
    originatingTransaction: Maybe<OriginatingTransaction>;
    /** Whether the fee has been fully refunded. If the fee is only partially refunded, this attribute will still be false. */
    refunded: Maybe<Scalars["Boolean"]>;
    /** A list of refunds that have been applied to the fee. */
    refunds: Maybe<ApplicationFeeRefundList>;
  };

export type ApplicationFeeList = Object & {
  object: Maybe<ObjectType>;
  url: Maybe<Scalars["String"]>;
  has_more: Maybe<Scalars["Boolean"]>;
  data: Maybe<Array<Maybe<ApplicationFee>>>;
};
 ...
 */
export type ApplicationFeeRefund = Node &
  Object & {
    /** Unique identifier for the object. */
    id: Scalars["ID"];
    /** String representing the object’s type. Objects of the same type share the same value. */
...
export type ApplicationFeeRefundCreateInput = {
  /** A positive integer, in pence, representing how much of this fee to refund. Can
...
export type ApplicationFeeRefundList = Object & {
  object: Maybe<ObjectType>;
  url: Maybe<Scalars["String"]>;
  has_more: Maybe<Scalars["Boolean"]>;
  data: Maybe<Array<Maybe<ApplicationFeeRefund>>>;
};

export type ApplicationFeeRefundListInput = {
...
export type ApplicationFeeRefundUpdateInput = {
  /** Set of key-value pairs that you can attach to an object. This can be useful
   * for storing additional information about the object in a structured format.
   * Individual keys can be unset by posting an empty value to them. All keys can
   * be unset by posting an empty value to metadata.
...
export type ApplicationFeeRefundWhereUniqueInput = {
  /** The identifier of the application fee to be refunded. */
  id: Scalars["ID"];
};

export type ApplicationFeeWhereUniqueInput = {
...
export type Mutation = {
   ...
   *
   * Once entirely refunded, an application fee can’t be refunded again. This
   * method will throw an error when called on an already-refunded application fee,
   * or when trying to refund more money than is left on an application fee.
   */
  createApplicationFeeRefund: Maybe<ApplicationFeeRefund>;
  /** Updates the specified application fee refund by setting the values of the
   * parameters passed. Any parameters not provided will be left unchanged.
   *
   * This request only accepts metadata as an argument.
   */
  updateApplicationFeeRefund: Maybe<ApplicationFeeRefund>;
};

export type MutationCreateApplicationFeeRefundArgs = {
  where: ApplicationFeeWhereUniqueInput;
  data: ApplicationFeeRefundCreateInput;
};

export type MutationUpdateApplicationFeeRefundArgs = {
  whereApplicationFee: ApplicationFeeWhereUniqueInput;
  whereApplicationFeeRefund: Maybe<ApplicationFeeRefundWhereUniqueInput>;
  data: Maybe<ApplicationFeeRefundUpdateInput>;
};
...
export type OriginatingTransaction = Charge | Transfer;
...
export type Query = {
   ...
   */
  retrieveApplicationFeeRefund: Maybe<ApplicationFeeRefund>;
   ...
   * method and the limit and starting_after parameters to page through additional refunds.
   */
  listApplicationFeeRefunds: Maybe<ApplicationFeeRefundList>;
};
...
export type QueryRetrieveApplicationFeeRefundArgs = {
  whereApplicationFee: ApplicationFeeWhereUniqueInput;
  whereApplicationFeeRefund: ApplicationFeeRefundWhereUniqueInput;
};

export type QueryListApplicationFeeRefundsArgs = {
  whereApplicationFee: ApplicationFeeWhereUniqueInput;
 ...
 * Payout object, with corresponding payout endpoints. For more information, read
 * about the transfer/payout split.
 */
export type Transfer = Node &
  Object & {
     ...
     */
    destination_payment: Maybe<Charge>;
    /** Unique identifier for the object. */
    id: Scalars["ID"];
    /** Has the value [true] if the object exists in live mode or the value [false] if the object exists in test mode. */
    livemode: Maybe<Scalars["Boolean"]>;
    ...
    reversals: Maybe<TransferReversalList>;
...
export type TransferReversal = Node &
  Object & {
    /** Amount, in %s. */
    amount: Maybe<Scalars["Int"]>;
    /** Balance transaction that describes the impact on your account balance. */
    ...
    destination_payment_refund: Maybe<Refund>;
    /** Unique identifier for the object. */
    id: Scalars["ID"];
    /** Set of key-value pairs that you can attach to an object. This can be useful
     * for storing additional information about the object in a structured format.
    ...
    source_refund: Maybe<Refund>;
    /** ID of the transfer that was reversed. */
    transfer: Maybe<Transfer>;
  };

/** A list of reversals that have been applied to the transfer. */
export type TransferReversalList = Object & {
  data: Maybe<Array<Maybe<TransferReversal>>>;
  /** True if this list has another page of items after this one that can be fetched. */
  has_more: Maybe<Scalars["Boolean"]>;
  /** String representing the object's type. Objects of the same type share the same value. Always has the value [list]. */
  object: Maybe<ObjectType>;
...
export type ApplicationFeeResolvers<
  Context = StripeContext,
  ParentType = ApplicationFee
> = {
  account: Resolver<Maybe<Account>, ParentType, Context>;
  ...
  charge: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  created: Resolver<Maybe<Scalars["Int"]>, ParentType, Context>;
  ...
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  originatingTransaction: Resolver<
    Maybe<OriginatingTransaction>,
    ParentType,
    Context
  >;
  refunded: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  refunds: Resolver<Maybe<ApplicationFeeRefundList>, ParentType, Context>;
};

export type ApplicationFeeListResolvers<
  Context = StripeContext,
  ParentType = ApplicationFeeList
> = {
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  url: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  has_more: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  data: Resolver<Maybe<Array<Maybe<ApplicationFee>>>, ParentType, Context>;
};

export type ApplicationFeeRefundResolvers<
  Context = StripeContext,
  ParentType = ApplicationFeeRefund
> = {
  id: Resolver<Scalars["ID"], ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  ...
  fee: Resolver<Maybe<ApplicationFee>, ParentType, Context>;
  metadata: Resolver<Maybe<Scalars["JSON"]>, ParentType, Context>;
};

export type ApplicationFeeRefundListResolvers<
  Context = StripeContext,
  ParentType = ApplicationFeeRefundList
> = {
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  url: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  has_more: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  data: Resolver<
    Maybe<Array<Maybe<ApplicationFeeRefund>>>,
    ParentType,
    Context
  >;
};
...
export type MutationResolvers<
  ...
  ParentType = Mutation
> = {
  createApplicationFeeRefund: Resolver<
    Maybe<ApplicationFeeRefund>,
    ParentType,
    Context,
    MutationCreateApplicationFeeRefundArgs
  >;
  updateApplicationFeeRefund: Resolver<
    Maybe<ApplicationFeeRefund>,
    ParentType,
    Context,
    MutationUpdateApplicationFeeRefundArgs
  >;
};
...
export type OriginatingTransactionResolvers<
  Context = StripeContext,
  ParentType = OriginatingTransaction
> = {
  __resolveType: TypeResolveFn<"Charge" | "Transfer", ParentType, Context>;
};
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  ...
  retrieveApplicationFeeRefund: Resolver<
    Maybe<ApplicationFeeRefund>,
    ParentType,
    Context,
    QueryRetrieveApplicationFeeRefundArgs
  >;
  listApplicationFeeRefunds: Resolver<
    Maybe<ApplicationFeeRefundList>,
    ParentType,
    Context,
    QueryListApplicationFeeRefundsArgs
  >;
};
...
> = {
  amount: Resolver<Maybe<Scalars["Float"]>, ParentType, Context>;
  amount_reversed: Resolver<Maybe<Scalars["Int"]>, ParentType, Context>;
  balance_transaction: Resolver<Maybe<BalanceTransaction>, ParentType, Context>;
  created: Resolver<Maybe<Scalars["DateTime"]>, ParentType, Context>;
  currency: Resolver<Maybe<Currency>, ParentType, Context>;
  description: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
  destination: Resolver<Maybe<Account>, ParentType, Context>;
  destination_payment: Resolver<Maybe<Charge>, ParentType, Context>;
  id: Resolver<Scalars["ID"], ParentType, Context>;
  livemode: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  metadata: Resolver<Maybe<Scalars["JSON"]>, ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  reversals: Resolver<Maybe<TransferReversalList>, ParentType, Context>;
  reversed: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  source_transaction: Resolver<Maybe<Charge>, ParentType, Context>;
  source_type: Resolver<Maybe<TransferSourceType>, ParentType, Context>;
  transfer_group: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
};
...
export type TransferReversalResolvers<
  Context = StripeContext,
  ParentType = TransferReversal
> = {
  amount: Resolver<Maybe<Scalars["Int"]>, ParentType, Context>;
  balance_transaction: Resolver<Maybe<BalanceTransaction>, ParentType, Context>;
  created: Resolver<Maybe<Scalars["Int"]>, ParentType, Context>;
  currency: Resolver<Maybe<Currency>, ParentType, Context>;
  destination_payment_refund: Resolver<Maybe<Refund>, ParentType, Context>;
  id: Resolver<Scalars["ID"], ParentType, Context>;
  metadata: Resolver<Maybe<Scalars["JSON"]>, ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  source_refund: Resolver<Maybe<Refund>, ParentType, Context>;
  transfer: Resolver<Maybe<Transfer>, ParentType, Context>;
};

export type TransferReversalListResolvers<
  Context = StripeContext,
  ParentType = TransferReversalList
> = {
  data: Resolver<Maybe<Array<Maybe<TransferReversal>>>, ParentType, Context>;
  has_more: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  url: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
};
...
export type Resolvers<Context = StripeContext> = {
  ...
  ApplicationFee: ApplicationFeeResolvers<Context>;
  ApplicationFeeList: ApplicationFeeListResolvers<Context>;
  ApplicationFeeRefund: ApplicationFeeRefundResolvers<Context>;
  ApplicationFeeRefundList: ApplicationFeeRefundListResolvers<Context>;
  ...
  OriginatingTransaction: OriginatingTransactionResolvers;
  ...
  TransferReversal: TransferReversalResolvers<Context>;
  TransferReversalList: TransferReversalListResolvers<Context>;
