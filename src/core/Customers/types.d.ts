...
export type CustomerCreateInput = {
  /** An integer amount in cents that represents the account balance for your
   * customer. Account balances only affect invoices. A negative amount represents
   * a credit that decreases the amount due on an invoice; a positive amount
   * increases the amount due on an invoice.
   */
  account_balance: Maybe<Scalars["Int"]>;
  /** The code of the coupon to apply to this subscription. A coupon applied to a
   * subscription will only affect invoices created for that particular
   * subscription. This can be unset by updating the value to null and then saving.
   */
   ...
   * alongside the customer in the dashboard. This can be unset by updating the
  ...
  invoice_settings: Maybe<CustomerInvoiceSettingInput>;
  /** Set of key-value pairs that you can attach to an object. This can be useful
   * for storing additional information about the object in a structured format.
   */
  metadata: Maybe<Scalars["JSON"]>;
  shipping: Maybe<CustomerShippingInput>;
  /** The source can either be a Token or a Source, as returned by Elements, or a
   * object containing a user’s credit card details (with the options shown below).
   * You must provide a source if the customer does not already have a valid source
   * attached, and you are subscribing the customer to be charged automatically for
   * a plan that is not free. Passing source will create a new source object, make
   * it the customer default source, and delete the old customer default if one
   * exists. If you want to add an additional source, instead use the card creation
   * API to add the card and then the customer update API to set it as the default.
   * Whenever you attach a card to a customer, Stripe will automatically validate the card.
   */
  source: Maybe<Scalars["String"]>;
  /** The customer’s tax information. Appears on invoices emailed to this customer. */
  tax_info: Maybe<CustomerTaxInformationInput>;
};
...
/** Default custom fields to be displayed on invoices for this customer. */
export type CustomerInvoiceSettingCustomFieldInput = {
...
/** Default invoice settings for this customer. */
export type CustomerInvoiceSettingInput = {
  /** Default custom fields to be displayed on invoices for this customer. */
  custom_fields: Maybe<CustomerInvoiceSettingCustomFieldInput>;
  /** Default footer to be displayed on invoices for this customer. */
  footer: Maybe<Scalars["String"]>;
};
...
export type CustomerPaymentSourceInput = {
  token: Maybe<Scalars["String"]>;
  soure: Maybe<Scalars["String"]>;
};
...
export type CustomerShippingInput = {
  /** Customer shipping address. */
...
export type CustomerTaxInformationInput = {
...
export type CustomerUpdateInput = {
   ...
   */
  account_balance: Maybe<Scalars["Int"]>;
  /** If you provide a coupon code, the customer will have a discount applied on all
   * recurring charges. Charges you create through the API will not have the
   * discount. This can be unset by updating the value to null and then saving.
   */
  coupon: Maybe<Scalars["ID"]>;
   ...
   * characters. This can be unset by updating the value to null and then saving.
   */
  email: Maybe<Scalars["String"]>;
  /** The prefix for the customer used to generate unique invoice numbers. Must be 3–12 uppercase letters or numbers. */
  invoice_prefix: Maybe<Scalars["String"]>;
  ...
  shipping: Maybe<CustomerShippingInput>;
  /** A Token’s or a Source’s ID, as returned by Elements. Passing source will
   * create a new source object, make it the new customer default source, and
   * delete the old customer default if one exists. If you want to add additional
   * sources instead of replacing the existing default, use the card creation API.
   * Whenever you attach a card to a customer, Stripe will automatically validate the card.
   */
  source: Maybe<Scalars["String"]>;
  /** The customer’s tax information. Appears on invoices emailed to this customer. */
...
export type Query = {
  node: Maybe<Node>;
  retrieveCustomer: Maybe<Customer>;
   ...
   */
  listCustomers: Maybe<CustomerList>;
};
...
export type QueryRetrieveCustomerArgs = {
  where: CustomerWhereUniqueInput;
};
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  ...
  retrieveCustomer: Resolver<
    Maybe<Customer>,
    ParentType,
    Context,
    QueryRetrieveCustomerArgs
  >;
  listCustomers: Resolver<
    Maybe<CustomerList>,
    ParentType,
    Context,
