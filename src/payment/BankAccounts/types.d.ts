...
export type BankAccountListInput = {
...
export type BankAccountVerifyInput = {
...
export type Billing = "chargeAutomatically" | "sendInvoice";
...
export type Mutation = {
  ...
  /** Updates the account_holder_name, account_holder_type, and metadata of a bank
   ...
   * banks. If your customer's bank is not supported or you do not wish to
   * integrate with Plaid, you must manually verify the customer's bank account using the API.
   */
  verifyBankAccount: Maybe<BankAccount>;
};
...
export type Query = {
   ...
   * bank account stored on the Stripe account.
   */
  retrieveBankAccount: Maybe<BankAccount>;
  /** You can see a list of the bank accounts belonging to a Customer. Note that the
   ...
   */
  listBankAccounts: Maybe<ListBankAccountPayload>;
};

export type QueryRetrieveBankAccountArgs = {
  whereCustomer: CustomerWhereUniqueInput;
  whereBankAccount: BankAccountWhereUniqueInput;
};
...
export type QueryListBankAccountsArgs = {
  whereCustomer: CustomerWhereUniqueInput;
  input: Maybe<BankAccountListInput>;
};
...
export type DeleteBankAccountPayloadResolvers<
  Context = StripeContext,
  ParentType = DeleteBankAccountPayload
> = {
  id: Resolver<Maybe<Scalars["ID"]>, ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
...
export type MutationResolvers<
  ...
  ParentType = Mutation
> = {
  createBankAccount: Resolver<
    Maybe<BankAccount>,
    ParentType,
    Context,
    MutationCreateBankAccountArgs
  >;
  updateBankAccount: Resolver<
    Maybe<BankAccount>,
    ParentType,
    Context,
    MutationUpdateBankAccountArgs
  >;
  deleteBankAccount: Resolver<
    Maybe<DeleteBankAccountPayload>,
    ParentType,
    Context,
    MutationDeleteBankAccountArgs
  >;
  verifyBankAccount: Resolver<
    Maybe<BankAccount>,
    ParentType,
    Context,
    MutationVerifyBankAccountArgs
  >;
};
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  retrieveBankAccount: Resolver<
    Maybe<BankAccount>,
    ParentType,
    Context,
    QueryRetrieveBankAccountArgs
  >;
  listBankAccounts: Resolver<
    Maybe<ListBankAccountPayload>,
    ParentType,
    Context,
    QueryListBankAccountsArgs
  >;
};
...
export type Resolvers<Context = StripeContext> = {
  ...
  DeleteBankAccountPayload: DeleteBankAccountPayloadResolvers<Context>;
