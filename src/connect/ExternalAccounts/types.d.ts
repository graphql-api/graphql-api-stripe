...
export type CardObjectType = "card";
...
export type ExternalAccountWherUniqueInput = {
  id: Scalars["ID"];
};

export type ExternalBankAccountCreateInput = {
   ...
   */
  external_account: Maybe<BankAccountInput>;
  /** When set to true, or if this is the first external account added in this
   * currency, this account becomes the default external account for its currency.
   */
  default_for_currency: Maybe<Scalars["Boolean"]>;
  /** A set of key-value pairs that you can attach to an external account object. It
   * can be useful for storing additional information about the external account in
   * a structured format.
   */
  metadata: Maybe<Scalars["JSON"]>;
};

export type ExternalBankAccountUpdateInput = {
  /** The name of the person or business that owns the bank account. This can be
...
export type ExternalCardCreateInput = {
...
export type ExternalCardUpdateInput = {
...
export type ExterrnalCardInput = {
  ...
  /** Required when adding a card to an account (not applicable to customers or
   * recipients). The card (which must be a debit card) can be used as a transfer
   * destination for funds in this currency. Currently, the only supported currency
   * for debit card transfers is usd.
   */
  currency: Maybe<Currency>;
  /** Cardholder's full name. */
  name: Maybe<Scalars["String"]>;
  /** A set of key-value pairs that you can attach to a card object. This can be
   * useful for storing additional information about the card in a structured format.
   */
  metadata: Maybe<Scalars["JSON"]>;
  /** Applicable only on accounts (not customers or recipients). If you set this to
   * true (or if this is the first external account being added in this currency),
...
export type Mutation = {
   ...
   *
   * If the bank account's owner has no other external account in the bank
   * account's currency, the new bank account will become the default for that
   * currency. However, if the owner already has a bank account for that currency,
   * the new account will become the default only if the default_for_currency
   * parameter is set to true.
   */
  createExternalBankAccount: Maybe<BankAccount>;
   ...
   * is not the Stripe account's default currency. Otherwise, before deleting the
   * account, you must set another external account to be the default for the currency.
   */
  updateExternalBankAccount: Maybe<BankAccount>;
  /** You can delete destination bank accounts from a Custom account.
   *
   * If a bank account's default_for_currency property is true, it can only be
   * deleted if it is the only external account for that currency, and the currency
   ...
   * account, you must set another external account to be the default for the currency.
   */
  deleteExternalBankAccount: Maybe<BankAccount>;
   ...
   * the default. However, if the owner already has a default then it will not
   * change. To change the default, you should set default_for_currency to true
   * when creating a card for a Custom account.
   */
  createExternalCard: Maybe<Card>;
   ...
   * details. Stripe also works directly with card networks so that your customers
   * can continue using your service without interruption.
   */
  updateExternalCard: Maybe<Card>;
  /** If a card's default_for_currency property is true, it can only be deleted if
   * it is the only external account for that currency, and the currency is not the
   * Stripe account's default currency. Otherwise, before deleting the card, you
   * must set another external account to be the default for the currency.
   */
  deleteExternalCard: Maybe<Card>;
};

export type MutationCreateExternalBankAccountArgs = {
  whereAccount: AccountWhereUniqueInput;
  data: Maybe<ExternalBankAccountCreateInput>;
};

export type MutationUpdateExternalBankAccountArgs = {
  whereAccount: AccountWhereUniqueInput;
...
export type MutationCreateExternalCardArgs = {
  whereAccount: AccountWhereUniqueInput;
  data: ExternalCardCreateInput;
};

export type MutationUpdateExternalCardArgs = {
  whereAccount: AccountWhereUniqueInput;
  whereCard: CardWhereUniqueInput;
  data: ExternalCardUpdateInput;
};

export type MutationDeleteExternalCardArgs = {
  whereAccount: AccountWhereUniqueInput;
  whereCard: CardWhereUniqueInput;
};
...
export type Query = {
  node: Maybe<Node>;
  retrieveExternalAccount: Maybe<ExternalAccount>;
  listExternalAccount: Maybe<ExternalAccountList>;
  /** By default, you can see the 10 most recent external accounts stored on a
   * Custom account directly on the object, but you can also retrieve details about
   * a specific bank account stored on the Custom account.
   */
  retrieveExternalBankAccount: Maybe<BankAccount>;
   ...
   * the corresponding Stripe object. If you need more than those 10, you can use
   * this API method and the limit and starting_after parameters to page through
   * additional bank accounts.
   */
  listExternalBankAccounts: Maybe<ListBankAccountPayload>;
  /** By default, you can see the 10 most recent external accounts stored on a
   * Custom account directly on the object, but you can also retrieve details about
   * a specific card stored on the Custom account.
   */
  retrieveExternalCard: Maybe<Card>;
   ...
   */
  listExternalCards: Maybe<ListCardPayload>;
};
...
export type QueryRetrieveExternalAccountArgs = {
  whereAccount: AccountWhereUniqueInput;
  whereExternalAccount: ExternalAccountWherUniqueInput;
};

export type QueryListExternalAccountArgs = {
  whereAccount: AccountWhereUniqueInput;
  where: ExternalAccountWhereInput;
};

export type QueryRetrieveExternalBankAccountArgs = {
  whereAccount: Maybe<AccountWhereUniqueInput>;
  whereBankAccount: Maybe<BankAccountWhereUniqueInput>;
};

export type QueryListExternalBankAccountsArgs = {
  whereAccount: Maybe<AccountWhereUniqueInput>;
  where: Maybe<ExternalAccountWhereInput>;
};

export type QueryRetrieveExternalCardArgs = {
  whereAccount: Maybe<AccountWhereUniqueInput>;
  whereCard: Maybe<CardWhereUniqueInput>;
};

export type QueryListExternalCardsArgs = {
  whereAccount: Maybe<AccountWhereUniqueInput>;
  where: Maybe<ExternalAccountWhereInput>;
};
...
export type ListCardPayloadResolvers<
  Context = StripeContext,
  ParentType = ListCardPayload
> = {
  data: Resolver<Maybe<Array<Maybe<Card>>>, ParentType, Context>;
  hasMore: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  object: Resolver<Maybe<ObjectType>, ParentType, Context>;
  url: Resolver<Maybe<Scalars["String"]>, ParentType, Context>;
};
...
export type MutationResolvers<
  ...
  ParentType = Mutation
> = {
  createExternalBankAccount: Resolver<
    Maybe<BankAccount>,
    ParentType,
    Context,
    MutationCreateExternalBankAccountArgs
  >;
  updateExternalBankAccount: Resolver<
    Maybe<BankAccount>,
    ParentType,
    Context,
    MutationUpdateExternalBankAccountArgs
  >;
  deleteExternalBankAccount: Resolver<
    Maybe<BankAccount>,
    ParentType,
    Context,
    MutationDeleteExternalBankAccountArgs
  >;
  createExternalCard: Resolver<
    Maybe<Card>,
    ParentType,
    Context,
    MutationCreateExternalCardArgs
  >;
  updateExternalCard: Resolver<
    Maybe<Card>,
    ParentType,
    Context,
    MutationUpdateExternalCardArgs
  >;
  deleteExternalCard: Resolver<
    Maybe<Card>,
    ParentType,
    Context,
    MutationDeleteExternalCardArgs
  >;
};
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  ...
  retrieveExternalAccount: Resolver<
    Maybe<ExternalAccount>,
    ParentType,
    Context,
    QueryRetrieveExternalAccountArgs
  >;
  listExternalAccount: Resolver<
    Maybe<ExternalAccountList>,
    ParentType,
    Context,
    QueryListExternalAccountArgs
  >;
  retrieveExternalBankAccount: Resolver<
    Maybe<BankAccount>,
    ParentType,
    Context,
    QueryRetrieveExternalBankAccountArgs
  >;
  listExternalBankAccounts: Resolver<
    Maybe<ListBankAccountPayload>,
    ParentType,
    Context,
    QueryListExternalBankAccountsArgs
  >;
  retrieveExternalCard: Resolver<
    Maybe<Card>,
    ParentType,
    Context,
    QueryRetrieveExternalCardArgs
  >;
  listExternalCards: Resolver<
    Maybe<ListCardPayload>,
    ParentType,
    Context,
    QueryListExternalCardsArgs
  >;
};
...
export type Resolvers<Context = StripeContext> = {
  ...
  ListCardPayload: ListCardPayloadResolvers<Context>;
