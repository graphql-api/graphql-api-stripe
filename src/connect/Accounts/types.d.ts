...
export type AccountCreateInput = {
  ...
  type: Maybe<AccountCreateType>;
  /** The country in which the account holder resides, or in which the business is
   * legally established. This should be an ISO 3166-1 alpha-2 country code. For
   * example, if you are in the United States and the business for which you’re
   * creating an account is legally represented in Canada, you would use CA as the
   * country for the account being created.
   */
  country: Maybe<CountryCode>;
  /** The email address of the account holder. For Custom accounts, this is only to
   * make the account easier to identify to you: Stripe will never directly email your users.
   */
  email: Maybe<Scalars["String"]>;
  /** An account token, used to securely provide details to the account. */
  account_token: Maybe<Scalars["ID"]>;
  /** Non-essential business information about the account */
  business_profile: Maybe<BusinessProfileInput>;
  ...
  /** Three-letter ISO currency code representing the default currency for the
   * account. This must be a currency that Stripe supports in the account’s country.
   */
  default_currency: Maybe<Currency>;
   ...
   * the external_account parameter for bank account creation.
   */
  external_account: Maybe<BankAccountCreateInput>;
  /** Information about the person represented by the account. This field is null unless business_type is set to individual. */
  individual: Maybe<IndividualInput>;
  /** A set of key-value pairs that you can attach to an Account object. This can be
   * useful for storing additional information about the account in a structured format.
   */
  metadata: Maybe<Scalars["JSON"]>;
  /** The set of capabilities you want to unlock for this account (US only). Each
   * capability will be inactive until you have provided its specific requirements
   * and Stripe has verified them. An account may have some of its requested
   * capabilities be active and some be inactive. This can be unset by updating the
   * value to null and then saving.
   */
  requested_capabilities: Maybe<Array<Maybe<RequestedCapability>>>;
...
export type AccountCreateType = "custom";
...
export type AccountDeclineChargeOn = {
   ...
   */
  cvs_failure: Maybe<Scalars["Boolean"]>;
};
...
export type AccountRejectInput = {
  reason: AccountRejectReason;
};

export type AccountRejectReason = "fraud" | "terms_of_service" | "other";
...
export type BankAccountCreateInput = {
  /** Either a token, like the ones returned by Stripe.js, or a dictionary
   * containing a user’s bank account details (with the options shown below).
   */
  source: Maybe<BankAccountInput>;
...
export type BrandingInput = {
  ...
  /** (ID of a file upload) A logo for the account that will be used in Checkout
   * instead of the icon and without the account’s name next to it if provided.
   * Must be at least 128px x 128px. This can be unset by updating the value to
...
export type CardPaymentsInput = {
  /** Automatically declines certain charge types regardless of whether the card issuer accepted or declined the charge. */
  decline_on: Maybe<DeclineOnInput>;
  /** The default text that appears on credit card statements when a charge is made.
   * This field prefixes any dynamic statement_descriptor specified on the charge.
   * statement_descriptor_prefix is useful for maximizing descriptor space for the
   * dynamic portion.
...
export type ConnectedAccountsWhereInput = {
...
export type LoginLinkCreateInput = {
...
export type Mutation = {
   ...
   *
   * For Standard accounts, parameters other than country, email, and type are used
   * to prefill the account application that we ask the account holder to complete.
   */
   ...
   */
  rejectAccount: Maybe<Account>;
  /** Creates a single-use login link for an Express account to access their Stripe dashboard.
   *
   * You may only create login links for Express accounts connected to your platform.
   */
  createLoginLink: Maybe<LoginLink>;
};
...
export type PayoutsInput = {
  /** A Boolean indicating whether Stripe should try to reclaim negative balances
   * from an attached bank account. For details, see Understanding Connect Account Balances.
   */
  debit_negative_balances: Maybe<Scalars["Boolean"]>;
  /** Details on when funds from charges are available, and when they are paid out
   * to an external account. For details, see our Setting Bank and Debit Card
   * Payouts documentation.
   */
  schedule: Maybe<PayoutsScheduleInput>;
  /** The text that appears on the bank account statement for payouts. If not set,
   * this defaults to the platform’s bank descriptor as set in the Dashboard.
   */
  statement_descriptor: Maybe<Scalars["String"]>;
...
export type PayoutsScheduleInput = {
  /** The number of days charge funds are held before being paid out. May also be
   * set to minimum, representing the lowest available value for the account
   * country. Default is minimum. The delay_days parameter does not apply when the
   * interval is manual.
   */
   ...
   */
  weekly_anchor: Maybe<WeeklyAnchor>;
};
...
export type Query = {
  retrieveAccount: Maybe<Account>;
  /** Returns a list of accounts connected to your platform via Connect. If you’re not a platform, the list is empty. */
  listConnectedAccounts: Maybe<AccountList>;
};

export type QueryRetrieveAccountArgs = {
  where: AccountWhereUniqueInput;
};

export type QueryListConnectedAccountsArgs = {
  where: Maybe<ConnectedAccountsWhereInput>;
};
...
export type RequestedCapability = "cardPayments" | "platformPayments";

export type ScheduleInterval = "daily" | "manual" | "weekly" | "monthly";
...
export type SettingsInput = {
  ...
  /** Settings specific to card charging on the account. */
  card_payments: Maybe<CardPaymentsInput>;
  /** Settings that apply across payment methods for charging on the account. */
  payments: Maybe<PaymentsInput>;
  /** Settings specific to the account’s payouts. */
  payouts: Maybe<PayoutsInput>;
};
...
export type TosAcceptance = {
   ...
   * the Stripe Services Agreement. This can be unset by updating the value to null
   * and then saving.
   */
...
export type AccountDeclineChargeOnResolvers<
  Context = StripeContext,
  ParentType = AccountDeclineChargeOn
> = {
  avs_failure: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
  cvs_failure: Resolver<Maybe<Scalars["Boolean"]>, ParentType, Context>;
};
...
> = {
  __resolveType: TypeResolveFn<"BankAccount" | "Card", ParentType, Context>;
  default_for_currency: Resolver<
    Maybe<Scalars["Boolean"]>,
    ParentType,
    Context
...
> = {
  ...
  >;
  rejectAccount: Resolver<
    Maybe<Account>,
    ParentType,
    Context,
    MutationRejectAccountArgs
  >;
  createLoginLink: Resolver<
    Maybe<LoginLink>,
    ParentType,
    Context,
    MutationCreateLoginLinkArgs
  >;
};
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  retrieveAccount: Resolver<
    Maybe<Account>,
    ParentType,
    Context,
    QueryRetrieveAccountArgs
  >;
  listConnectedAccounts: Resolver<
    Maybe<AccountList>,
    ParentType,
    Context,
    QueryListConnectedAccountsArgs
  >;
};
...
export type Resolvers<Context = StripeContext> = {
  ...
  AccountDeclineChargeOn: AccountDeclineChargeOnResolvers<Context>;
