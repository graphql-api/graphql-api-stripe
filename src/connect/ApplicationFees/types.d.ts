...
export type ApplicationFeeWhereInput = {
...
export type Query = {
   ...
   */
  retrieveApplicationFee: Maybe<ApplicationFee>;
   ...
   * appearing first.
   */
  listApplicationFees: Maybe<ApplicationFeeList>;
};

export type QueryRetrieveApplicationFeeArgs = {
  where: Maybe<ApplicationFeeWhereUniqueInput>;
};

export type QueryListApplicationFeesArgs = {
  where: Maybe<ApplicationFeeWhereInput>;
};
...
export type QueryResolvers<Context = StripeContext, ParentType = Query> = {
  retrieveApplicationFee: Resolver<
    Maybe<ApplicationFee>,
    ParentType,
    Context,
    QueryRetrieveApplicationFeeArgs
  >;
  listApplicationFees: Resolver<
    Maybe<ApplicationFeeList>,
    ParentType,
    Context,
    QueryListApplicationFeesArgs
  >;
};
